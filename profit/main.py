...
1300	1799
1400	1899''')],
    [sg.Button('ASIN'), sg.Button('PRINTCA'),sg.Button('PRINTEUA')],
    [sg.Text('min-> ', key='min')],
    [sg.Text('Preço min -> '), sg.Input(size=(6, 6))],
    [sg.Text('Preço max -> '), sg.Input(size=(6, 6))],
    [sg.Text('-------------------------------------------------------')],
    [sg.Radio('Canada', 'canada'), sg.Radio('', 'canada', default=True)],
    [sg.Radio('Estados Unidos', 'estados unidos'), sg.Radio('', 'estados unidos', default=True)],
    [sg.Text('-------------------------------------------------------')],
    [sg.Text('Preço Canadá min-> ', key='canadamin')],
    [sg.Text('Preço Canadá max-> ', key='canadamax')],
    [sg.OK()],
    [sg.Button('Enviar')],
]
